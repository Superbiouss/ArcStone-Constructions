...
export default function ServicePage({ params }: { params: { slug: string } }) {
  // Convert slug to title case (e.g., architectural-planning -> Architectural Planning)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-card border border-border rounded-lg p-12 text-center shadow-elevated">
          ...
          <p className="text-muted-foreground font-body text-lg max-w-2xl mx-auto">
            This is a placeholder page for the {title} service. The full detailed page will be implemented in a future phase.
          </p>
        </div>
      </div>
    </main>
